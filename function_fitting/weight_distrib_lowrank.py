# -*- coding: utf-8 -*-
"""Distributed low-rank matrix-weighted FL with fixed local training steps."""
...
parser.add_argument("--out_root", type=str, default="Results_lowrank")
...
# -------------------- 输出目录 --------------------
run_name = (
    f"lowrank_tb-{int(TIME_BUDGET)}s_mr-{MAX_ROUNDS}"
    f"_epochs{LOCAL_EPOCHS}_step{STEP_SIZE}_k{TOP_K}"
)
