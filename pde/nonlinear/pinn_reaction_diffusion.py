# -*- coding: utf-8 -*-
"""Distributed low-rank PINN for 1D nonlinear reaction-diffusion equation with Dirichlet boundary conditions.
PDE: -d²u/dx² + u² = f(x)
...
# -------------------- 输出目录 --------------------
run_name = (
    f"reaction_diffusion_1D_tb-{int(TIME_BUDGET)}s_mr-{MAX_ROUNDS}"
