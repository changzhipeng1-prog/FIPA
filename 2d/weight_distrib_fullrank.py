# -*- coding: utf-8 -*-
"""Distributed full-rank matrix-weighted FL with fixed local training steps (2D version)."""
...
parser.add_argument("--out_root", type=str, default="Results_fullrank_2d")
...
# -------------------- 输出目录 --------------------
run_name = (
    f"fullrank_2d_tb-{int(TIME_BUDGET)}s_mr-{MAX_ROUNDS}"
    f"_epochs{LOCAL_EPOCHS}_step{STEP_SIZE}_K{KX}x{KY}"
)
